...
import KeyRequestModal from './components/KeyRequestModal';
...
export default function Home() {
  const [showKeyRequestModal, setshowKeyRequestModal] = useState(false);
        ...
        <div className="h-screen w-screen overflow-hidden">
          <div className="grid grid-cols-3">
            ...
            <div className="w-full flex space-x-2 justify-end pr-1">
              ...
              <button className="mr-1 mt-1 py-2 px-4 bg-white rounded hover:text-indigo-500" onClick={() => setshowKeyRequestModal(true)}>Request Creator Key</button>
          ...
          {showKeyRequestModal && <KeyRequestModal closeModal={() => setshowKeyRequestModal(false)} />}
